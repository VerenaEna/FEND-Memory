...
function winner() {
  ...
  winnerMessage.html(
    `<p class="winner-title">Congrats!</p><p class="winner-text">You finished in ${timerResult}!<p class="winner-text">You needed ${counter} moves</p><p class="winner-text">For this you get ${star} ${starsIcon}</p>`
  );
  clearInterval(interval);
  closeModal();
  playAgain();
